    ...
    public partial class n1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_buys_detailes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_buys_detailes_buys_BuyId",
                        column: x => x.BuyId,
                        principalTable: "buys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_buys_detailes_products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_buys_detailes_BuyId",
                table: "buys_detailes",
                column: "BuyId");

            migrationBuilder.CreateIndex(
                name: "IX_buys_detailes_ProductId",
                table: "buys_detailes",
                column: "ProductId");
